...
(define translations-by-locale
  '([(en) . ([err-required          . "This field is required."]
             ...
             [err-list-elt-required . "This field is required."]
             [err-list-elt-overflow . "This field should not exist."])]
    [(ro) . ([err-required          . "Acest câmp este obligatoriu."]
             ...
             [err-list-elt-required . "Acest câmp este obligatoriu."]
             [err-list-elt-overflow . "Acest câmp nu ar trebui să existe."])]))
